...
class SimpleULHooks:
    def premium_and_loads(
        ...
        return PremiumResult(
            ...
            premium_load=quantize_money(premium_load),
    ...
    def monthly_charges(
        ...
        return ChargeResult(
            policy_fee=quantize_money(policy_fee),
            admin_fee=quantize_money(admin_fee),
            coi_charge=quantize_money(coi_charge),
            charges_total=quantize_money(charges_total),
        )
